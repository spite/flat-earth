...
export const showGraticule = signal(true);
export const showOutlines = signal(true);
...
export const sunAzimuth = signal(312);
export const sunAltitude = signal(34);
...
export const waterFill = signal(false);
